...
const Navbar = props => {
    ...
    return(<li className="col-auto">
    <Link id="menu-item" to="/myfavorite">my Favorite</Link>
    </li>  )
        }
    ...
    const guest = () => {
        return (
            <ul className="drop"  >
                ...
                <li >
                  <a className="active">  <Link to="/register">Register</Link></a>
                </li>
                {/* <li >
                   <a> <Link to="/acceuil">acceuil</Link></a>
                </li> */}
                <li >
                   <a className="active"> <Link to="/contact">Contactez Nous</Link></a>
                </li>
            </ul>
        )
    ...
    return (
        <div className="nav">
            ...
            <label className="logo"> <Link to="/acceuil">TuniTransport</Link></label>
            {
